...
class RolePermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $shopManager->syncPermissions([
            ...
            Permission::create(['name' => 'category:elete']),
            ...
            Permission::create(['name' => 'review:elete']),
            ...
            Permission::create(['name' => 'attribute:elete']),
            ...
            Permission::create(['name' => 'value:elete']),
            ...
            Permission::create(['name' => 'delivery-method:elete']),
            ...
            Permission::create(['name' => 'payment-type:elete']),
